...
struct __NandPhyInfoPar_t HynixNandTbl[] =
{
    ...
    { {0xad, 0xde, 0x14, 0xa7, 0x42, 0x4a, 0xff, 0xff }, 1,    32,     256,     2048,   0x0188,   896,    50,     4,  0x040704,      0,    &PhysicArchiPara3 },   // H27UCG8T2ETR-BC 16nm 8G, ECC 40-bit/1KB
    { {0xad, 0xde, 0x14, 0x9e, 0x34, 0x4a, 0xff, 0xff }, 1,    16,     256,     2048,   0x0188,   896,    50,     4,  0x040704,      0,    &PhysicArchiPara3 },   // H27U... single-plane? 16nm
    //---------------------------------------------------------------------------------------------------------------------------
    { {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }, 0,     0,       0,        0,   0x0000,     0,     0,     0,      0,         0,   0                 },   // NULL
};
